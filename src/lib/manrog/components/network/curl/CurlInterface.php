 ...
 *
 * @version 1.0
 * @author  Manuel Rogoll<manuel.rogoll@manrog.de>
 */
interface CurlInterface
{
    /**
     ...
     * @param $age
     *
     * @return array Returns an associative array with the following elements: (look at Returns an associative array
